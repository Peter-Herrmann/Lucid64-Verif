...
class Lucid64(pluginTemplate):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.dut_exe = os.path.join(config['PATH'] if 'PATH' in config else "","Lucid64")
    ...
    def initialise(self, suite, work_dir, archtest_env):
       ...
       # Compile the Verilator + Testbench executable
       utils.shellCommand('make -C ./sim clean compile').run()
    ...
    def build(self, isa_yaml, platform_yaml):
      ...
      # for Lucid64 start building the '--isa' argument. the self.isa is dutnmae specific and may not be
      # useful for all DUTs
